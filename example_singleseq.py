...
workdir = "tests/output/test_run_singleseq"  # working directory
...
test = phyl_up.PhylogeneticUpdater(id_to_spn, seqaln, mattype, None, None, conf, ignore_acc_list=ignore_acc)
test.run(1)
